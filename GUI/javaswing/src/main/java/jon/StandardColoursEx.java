...
// JLabel is a specific component with a default transparent background
// overide isOpaque
...
public class StandardColoursEx extends JFrame {
    ...
    private void initUI() {
        // Array of built in static colour values
        Color[] stdCols = { Color.black, Color.blue, Color.cyan,
            Color.darkGray, Color.gray, Color.green, Color.lightGray,
            Color.magenta, Color.orange, Color.pink, Color.red,
            Color.white, Color.yellow };
            
            // A list of JLabel components is created and a new label is create with createColouredLAbel
    ...
    // Creates a new label, set a minimum size for the label, and set the background color
